...
export function ProfileCard({ seller }: { seller: DashboardSeller }) {
  return (
    <div className="flex items-center gap-7 lg:min-w-[405px]">
      <Avatar name={seller.username} profileImage={seller.profileImage} size="large" />
      <div className="min-w-0">
        <h2 className="truncate text-[22px] font-bold tracking-[-0.02em] text-[#0b1426]">{seller.username}</h2>
